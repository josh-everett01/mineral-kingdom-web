...
async function applyCartIdFromResponse(upstream: Response, response: NextResponse) {
...
export async function DELETE(
  ...
  try {
    upstream = await fetch(`${API_BASE_URL}/api/cart/lines/${encodeURIComponent(offerId)}`, {
      method: "DELETE",
  ...
  await applyCartIdFromResponse(upstream, response)
  return response
}