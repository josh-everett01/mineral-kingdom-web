...
async function forwardOnce(
  ...
  return fetch(`${API_BASE_URL}/api/orders/${encodeURIComponent(orderId)}/payments/start`, {
    method: "POST",
    headers,
...
export async function POST(req: NextRequest, context: RouteContext) {
  ...
  const body = (await req.json().catch(() => null)) as StartOrderPaymentRequest | null
